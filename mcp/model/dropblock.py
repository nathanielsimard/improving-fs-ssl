...
# Implementation from: https://github.com/kjunelee/MetaOptNet/blob/master/models/dropblock.py
...
class DropBlock(nn.Module):
    ...
    def _compute_block_mask(self, mask):
        ...
        if nr_blocks > 0:
            ...
            padded_mask = F.pad(
                mask, (left_padding, right_padding, left_padding, right_padding)  # type: ignore
            )
            padded_mask[
