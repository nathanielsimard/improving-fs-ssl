...
from mcp.model.dropblock import DropBlock

# Implementation from: https://github.com/kjunelee/MetaOptNet/blob/master/models/ResNet12_embedding.py
...
class ResNet(nn.Module):
    def __init__(
        self, block, keep_prob=1.0, avg_pool=False, drop_rate=0.0, dropblock_size=5
    ):
        self.inplanes = 3
